...
const elementsToTranslate = {
  ...
  continueWithGoogle: document.querySelector(
    'button[aria-label="Continue with Google"] .social-content'
  )!,
  signInWithApple: document.querySelector(
    'button[aria-label="Sign in with Apple"] .social-content'
  )!,
...
function setLanguage(lang: Language) {
  ...
  setTextAfterIcon(
    elementsToTranslate.continueWithGoogle,
